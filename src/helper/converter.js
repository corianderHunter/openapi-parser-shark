...
common.sanitise = (s) => s
common.sanitiseAll = (s) => {
  return s.split('/').join('_')
}

const statusCodes = require('swagger2openapi/lib/statusCodes.js').statusCodes

const ourVersion = require('swagger2openapi/package.json').version
